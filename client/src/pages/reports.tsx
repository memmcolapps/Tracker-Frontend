  ...
  const columns = [
    {
      ...
      render: (value: string, row: Report) => (
        <div>
          ...
          <div className="text-sm text-gray-500">{row.organizationId ? 'Organization specific' : 'All organizations'}</div>
        </div>
      ),
    },
    {
      ...
      label: 'Type',
      render: (value: string) => (
        <div className="text-sm text-gray-900 capitalize">{value.replace('_', ' ')}</div>
      ),
    },
    {
            ...
            <div>
              ...
              <Select>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="organization">Organization Report</SelectItem>
